...
// NB: Ultrasonic was angled 53 degree with the road to detect speed
//servo: 2; Ultrasonic trig: 3, echo: 4;
//RFID sda or SS: 10, sck: 13, mosi: 11, miso: 12, rst: 9
...
int range = 30;  
double limit = 25;  // set speed limit
